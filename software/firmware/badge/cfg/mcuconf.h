...
/*
 * For some reason ChibiOS doesn't think the STM32F746 has a
 * random number generator, but it does, and we want it.
 */
...
#define STM32_PLLSAIDIVQ_VALUE              17
...
/* Note: was originally 2,4, but this conflicts with SAI2 block A */
